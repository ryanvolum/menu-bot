...
namespace FoodBot.Dialogs
{
    public class FoodBotDialogSet : DialogSet
    {
        ...
        public static string MenuDialogId => "menuDialog";
            ...
            : base(dialogStatePropertyAccessor)
        {
            ...
            .Add(new ChoicePrompt(MENUPROMPT))
            .Add(new DonateFoodDialog(DONATEFOODDIALOG))
            .Add(new FindFoodDialog(FINDFOODDIALOG))
            .Add(new ContactDialog(CONTACTDIALOG));
        }
        ...
        {
            return await stepContext.ReplaceDialogAsync(MenuDialogId, null, cancellationToken).ConfigureAwait(false); ;
        }
    }
}
